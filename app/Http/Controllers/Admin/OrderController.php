    ...
    public function update(Request $request, $id)
    {
        ...
        if ($request->status == 3) {
            ...
            foreach ($orderDetails as $orderDetail) {
                ...
                Product::where('id', $orderDetail->product_id)->update(['qty' => $product->qty + $orderDetail->qty]);
                Product::where('id', $orderDetail->product_id)->update(['qty_buy' => $product->qty_buy - $orderDetail->qty ]);
            }
        }
